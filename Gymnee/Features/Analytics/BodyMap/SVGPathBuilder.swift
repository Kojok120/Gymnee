...
//  Gymnee
//
//  SVG のパスコマンドを SwiftUI の Path へ組み立てる。
//
//  出典: MuscleMap by Melih Colpan — https://github.com/melihcolpan/MuscleMap
//  Copyright (c) 2026 Melih Colpan. Licensed under the MIT License.
//  BodyMapArtwork のパスを描くために、MuscleMap の SVGPathCommand / PathBuilder を取り込んだもの。
//  ライセンス全文は NOTICE.md を参照。
//
