...
enum RoutineTemplates {
    ...
    static let all: [Template] = [
        ...
        // 部位別の日（旧・計画シートの「自由入力」プリセットをテンプレ化）。
        .init(name: "胸の日", detail: "胸", sets: 4,
              exerciseNames: ["ベンチプレス", "インクラインベンチプレス", "ダンベルプレス", "チェストプレス", "ペックフライ"]),
        .init(name: "背中の日", detail: "背中", sets: 4,
              exerciseNames: ["デッドリフト", "懸垂", "ベントオーバーロウ", "ラットプルダウン", "シーテッドロウ"]),
        .init(name: "脚の日", detail: "脚", sets: 4,
              exerciseNames: ["スクワット", "レッグプレス", "レッグエクステンション", "レッグカール", "カーフレイズ"]),
        .init(name: "肩・腕", detail: "肩・二頭・三頭", sets: 4,
              exerciseNames: ["ショルダープレス", "サイドレイズ", "バーベルカール", "トライセプスプレスダウン", "スカルクラッシャー"]),
        .init(name: "有酸素", detail: "ランニング/ウォーキング/バイシクル", sets: 1,
              exerciseNames: ["ランニング", "ウォーキング", "バイシクル"]),
    ]
